...
//     alert(`BVM/B305/${componentName}/${index + 1}`);
//   };
...
// export default function B305LabLayout1() {
//   return (
//     <LabLayoutRoot>
//       <Box className="breadcrumb">
//         <Breadcrumb
//           routeSegments={[{ name: 'Labs', path: '/labs' }, { name: 'B305' }]}
//         />
//       </Box>

//       <SimpleCard title="B305">
...
const PC = ({ rotated, rotate270, index }) => {
  ...
  const fetchProductInfo = async (category) => {
    try {
      ...
      const productId = `${index + 1}_26`; // Fetching based on B305 layout
      const response = await axios.get(`http://localhost:5000/api/product/${productId}/${category}/B305`, { headers: header });
...
export default function B305LabLayout1() {
  return (
    <LabLayoutRoot>
      <Box className="breadcrumb">
        <Breadcrumb routeSegments={[{ name: 'Labs', path: '/labs' }, { name: 'B305' }]} />
      </Box>
