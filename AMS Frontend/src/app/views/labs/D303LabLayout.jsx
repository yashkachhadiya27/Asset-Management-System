    ...
    export default function D303LabLayout() {
      const [isEditMode, setEditMode] = useState(false);
      const [pcPositions, setPcPositions] = useState([...Array(25)].map(() => ({ top: 0, left: 0 })));
      ...
      'Content-Type': 'application/json',
            ...
            const response = await axios.get(`${BASE_URL}/labs/D303/layout`,{ headers });
      ...
      'Content-Type': 'application/json', // Optional: Specify content type
          ...
          await axios.put(`${BASE_URL}/labs/D303/layout`, { pcPositions },{ headers });
      ...
      return (
        <LabLayoutRoot>
          <Box className="breadcrumb">
            <Breadcrumb routeSegments={[{ name: 'Labs', path: '/labs' }, { name: 'D303' }]} />
          </Box>

          <SimpleCard title="D303">
